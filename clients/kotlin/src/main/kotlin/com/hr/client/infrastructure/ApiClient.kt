package com.hr.client.infrastructure

import com.hr.client.auth.HttpBearerAuth
...
import com.hr.client.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey: String = "com.hr.client.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://api.hrapp.io")
        }
    }
}
